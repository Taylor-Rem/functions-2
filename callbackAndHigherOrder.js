...
// console.log("The answer is " + multiply(4, 3));
...
const contains = (arr, str, callback) => {
  arr.includes(str) ? callback(true) : callback(false);
};
...
let favNumber = addingFactory(24);
let addNumber = favNumber(10);
